...
console.log('Part 1 =', greatestElementDifferenceAfterNSteps(polymerTemplate, rulesList, 10))
console.log('Part 2 =', greatestElementDifferenceAfterNSteps(polymerTemplate, rulesList, 40))